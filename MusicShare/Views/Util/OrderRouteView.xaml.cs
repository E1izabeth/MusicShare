    ...
    public partial class OrderRouteView : Grid
    {
        ...
        public static readonly BindableProperty MapLocationsProperty =
            BindableProperty.Create("MapLocations", typeof(ObservableCollection<MapLocInfo>), typeof(OrderRouteView), default(ObservableCollection<MapLocInfo>),
                propertyChanged: CollectionBindingWatcher.For<OrderRouteView, MapLocInfo>(c => c._mapLocsCollectionBindingContext));
        ...
        public static readonly BindableProperty MapRoutesProperty =
            BindableProperty.Create("MapRoutes", typeof(ObservableCollection<MapRouteInfo>), typeof(OrderRouteView), default(ObservableCollection<MapRouteInfo>),
                propertyChanged: CollectionBindingWatcher.For<OrderRouteView, MapRouteInfo>(c => c._mapRoutesCollectionBindingContext));
        ...
        private CollectionBindingContext<MapLocInfo> _mapLocsCollectionBindingContext;
        private CollectionBindingContext<MapRouteInfo> _mapRoutesCollectionBindingContext;

        public OrderRouteView()
        {
            _mapLocsCollectionBindingContext = new CollectionBindingContext<MapLocInfo>();
            _mapLocsCollectionBindingContext.OnCollectionChanged += this.OnMapLocsCollectionChanged;

            _mapRoutesCollectionBindingContext = new CollectionBindingContext<MapRouteInfo>();
        ...
        private void OnMapLocsCollectionChanged(ObservableCollection<MapLocInfo> locs, NotifyCollectionChangedEventArgs e)
        {
        ...
        private void OnMapRoutesCollectionChanged(ObservableCollection<MapRouteInfo> routes, NotifyCollectionChangedEventArgs e)
        {
            if (e.Action == NotifyCollectionChangedAction.Remove ||
                e.Action == NotifyCollectionChangedAction.Replace)
            {
